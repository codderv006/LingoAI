    ...
    <section id="how-it-works" className="py-20 bg-muted/50">
      <div className="container">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-card border rounded-xl p-6 h-full flex flex-col">
                <div className={`h-12 w-12 rounded-full ${step.color} flex items-center justify-center text-white font-bold mb-4`}>
                  <step.icon className="h-6 w-6" />
                </div>
                <div className="text-5xl font-bold text-muted-foreground/20 absolute top-6 right-6">
                  {step.number}
                </div>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold mb-6">The 10-Step Learning Framework</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
            {[
              ...
              <motion.div
                key={index}
                className="bg-card border rounded-lg p-4 flex items-center justify-center text-center"
